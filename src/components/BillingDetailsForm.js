...
const BillingDetailsForm = ({ formData, handleAutoFill }) => {
    const { billingFormData, setBillingFormData } = useContext(BillingFormContext);
    ...
    const handleSubmit = (e) => {
        ...
        console.log('Billing Details submitted:', updatedFormData);
